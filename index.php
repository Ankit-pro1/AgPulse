        ...
        <div class="container">
            ...
            <form id="hero-form" action="./data/users.php" method="POST" class="needs-validation" novalidate>
                <div class="form-row">
                    ...
                    <div class="col">
                        <div class="d-flex" id="phoneNumber">
                            <select name="countryCode" id="" style="width: 36%;" required>
            ...
            <div class="row coverage-section-items">
                <div class="col-lg-3 col-md-6 item">
                    <div class="item-inner">
                        <img src="./images/pulse.jpg" alt="Pulses-image">
                ...
                <div class="col-lg-3 col-md-6 item">
                    <div class="item-inner">
                        <img src="./images/corn.jpg" alt="Corn-image">
                        <div class="item-overlay-content">
                            <div class="item-overlay-inner-content">
                                <!-- <p>Corn include:</p> -->
                                <li>Corn</li>
                ...
                <div class="col-lg-3 col-md-6 item">
                    <div class="item-inner">
                        <img src="./images/oilseed.jpg" alt="">
                        <div class="item-overlay-content">
                            <div class="item-overlay-inner-content">
                                <!-- <p>oilseeds include</p> -->
                                <li>Soyabean</li>
                                <li>Canola</li>
                                <li>Rapeseed</li>
                            </div>
...
<div class="free-subscrition-section padding">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h3>TWO WEEKS FREE TRIAL</h3>
            </div>
            <div class="col-md-6">
                <button class="custom-btn" data-toggle="modal" data-target="#myModal">TRY FOR FREE</button>
                <!-- Modal -->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="./data/users.php" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div class="form-group">
                                        <select name="langOpt[]" multiple id="langOpt2" class="form-control d-flex" required>
                                            <option value="" disabled>Select Products</option>
                                            <option value="pulses">Pulses</option>
                                            <option value="wheat">Wheat</option>
                                            <option value="corn">Corn</option>
                ...
                <div class="services-content">
                    ...
                    <div class="services-content-inner">
                        ...
                        <div class="row justify-content-center subscribe-btn">
                            <a href="./pages/subscribe.php" class="btn btn-success">Subscribe</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="services-content">
                    ...
                    <div class="services-content-inner">
                        <ul class="p-0">
                            ...
                            <li>
                                <i class="far fa-check-circle"></i>
                                Proprietary Yield Model
                            </li>
                            <li>
                                <i class="far fa-check-circle"></i>
                                Balance Sheets (S&D’s)
                            </li>
                            <li>
                                <i class="far fa-check-circle"></i>
...
<!-- <div id="twitter-feed" class="padding">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
            <a href="https://twitter.com/ankitkumar0506?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-show-count="false">Follow @ankitkumar0506</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
            </div>
...
<script>
    // Jquery for checkbox in select box
