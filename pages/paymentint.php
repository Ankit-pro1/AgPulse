        ...
        <div class="row" id="order-summary">
            ...
            <div class="col-12">
                ...
                <form action="demoint.php" method='POST' class="needs-validation" novalidate>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <div class="d-flex">
                                ...
                                <input type="tel" name="subwPhone" class="form-control" placeholder="Work Phone Number" required pattern="^[0-9]+$" style="flex: 75%">
                            </div>
                            <div class="valid-feedback">Valid.</div>
                        ...
                        <div class="col">
                            ...
                            <div class="d-flex">
                                ...
                                <input type="tel" name="subPhone" class="form-control" placeholder="Phone Number" style="flex: 75%;" pattern="^[0-9]+$">
                            </div>
                            <div class="valid-feedback">Valid.</div>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <label for="subCity">City <sup>*</sup></label>
                            <input type="text" name="subCity" class="form-control" placeholder="City" required>
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">Please enter your city name</div>
                        </div>
                        <div class="col">
                            <label for="subCountry">Country <sup>*</sup></label>
                            <select name="subCountry" class="form-control" required>
